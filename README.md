...
- Training loop: Ties everything together to train the model. Trains data in batches, propagates through the nework, makes predictions, and applies backpropagation to improve the accuracy of the model. \
